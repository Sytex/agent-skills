...
| `duplicate-automation <uuid> [name]` | Duplicate automation with all steps |
...
# Duplicate automation (with default name "{name} (Copy)")
~/.claude/skills/sytex/sytex --base-url https://app.sytex.io --org 331 duplicate-automation "612bb62f-1af7-4b1c-bccd-2ff040c03b21"

# Duplicate automation with custom name
~/.claude/skills/sytex/sytex --base-url https://app.sytex.io --org 331 duplicate-automation "612bb62f-1af7-4b1c-bccd-2ff040c03b21" "My New Automation"
